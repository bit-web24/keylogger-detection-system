...
class ModernLinuxKeyloggerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Keylogger Detection and Termination System")
    ...
    def update_after_scan(self, total_threats):
        ...
        if total_threats > 0:
            self.status_label.config(
                text="Threats Detected!", foreground=self.colors["danger"]
            )
    ...
    def terminate_selected(self):
        ...
        for item in selected:
            ...
            if messagebox.askyesno(
                ...
                "Warning: Only terminate if you're certain it's malicious.\n"
...
if __name__ == "__main__":
    ...
    app.log_monitor("Keylogger Detection and Termination System", "info")
